    ...
    <?php 
        ...
        if (isset($_GET['additions']) && 
   			$_GET['additions'] == 'both') {
    			...
    			$generatedPassword = array_random($wordBank).'-'.array_random($wordBank).$newNumber.$newCharacter ;
   			...
   			$_GET['additions'] == 'number') {
    			...
    			$generatedPassword = array_random($wordBank).'-'.array_random($wordBank).$newNumber ;
   			...
   			$_GET['additions'] == 'character') {
    			...
    			$generatedPassword = array_random($wordBank).'-'.array_random($wordBank).$newCharacter ;
    		...
    		$generatedPassword = array_random($wordBank).'-'.array_random($wordBank);
